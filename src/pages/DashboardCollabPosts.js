...
const DashboardCollabPosts = (props) => {
    let data={
        ...
        description: "I am looking for frontend developer, our project is about developing a web site VjCollab, for students of our college.\
    ...
    return (
        <div className=''>
            <div className=''>
            <h1 className='text-center m-0'>Your Posts!</h1>
                <Row xs={1} md={3} className="g-4 m-3">
                    {/* {Array.from({ length: 4 }).map((_, idx) => ( */}
                        <Col className=''>
                             <DashboardFeedCard {...data} />
                        </Col>
                        <Col className=''>
                             <DashboardFeedCard {...data} />
...
export default DashboardCollabPosts;
